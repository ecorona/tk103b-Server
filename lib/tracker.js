...
Tracker.prototype.stopTracking = function(){
  console.log('tracker->stopTracking');
  this.cmd('A');
};
...
Tracker.prototype.desactivarMotor = function(){
  console.log('tracker->desactivarMotor');
  this.cmd('J');
};

Tracker.prototype.activarMotor = function(){
  console.log('tracker->activarMotor');
  this.cmd('K');
};

Tracker.prototype.cancelHelp = function(){
  console.log('tracker->cancelHelp');
  this.cmd('E');
};
