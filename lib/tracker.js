...
Tracker.prototype.logCommand = function(cmd){
  if(this.logCommands){console.log(cmd);}
};
...
Tracker.prototype.send = function(data){
  if(this.logSend){console.log('tracker->send', data);}
