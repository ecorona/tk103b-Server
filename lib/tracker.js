...
Tracker.prototype.logCommand = function(cmd){
  if(this.logCommandCommands){console.log(cmd);}
};
...
Tracker.prototype.stopTracking = function(){
  this.logCommand('tracker->stopTracking');
  this.cmd('A');
};

Tracker.prototype.getPosition = function(){
  this.logCommand('tracker->getPosition');
  this.cmd('B');
};

Tracker.prototype.desactivarMotor = function(){
  this.logCommand('tracker->desactivarMotor');
  this.cmd('J');
};

Tracker.prototype.activarMotor = function(){
  this.logCommand('tracker->activarMotor');
  this.cmd('K');
};

Tracker.prototype.cancelHelp = function(){
  this.logCommand('tracker->cancelHelp');
  this.cmd('E');
};

Tracker.prototype.activarAlarma = function(){
  this.logCommand('tracker->activarAlarma');
  this.cmd('L');
};

Tracker.prototype.desactivarAlarma = function(){
  this.logCommand('tracker->desactivarAlarma');
  this.cmd('M');
};

Tracker.prototype.setSpeedLimit = function(limit){
  this.logCommand('tracker->setSpeedLimit', limit);
